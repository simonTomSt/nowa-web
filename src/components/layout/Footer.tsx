...
export default function Footer({ lang }: FooterProps) {
  ...
  const footerNavLinks = [
    {
      labelKey: "footer.links.aboutAdmixtures",
              ...
              <div className="flex items-center gap-3 text-white/70">
                ...
                <Dropdown>
                  <Button
                    ...
                    variant="none"
                    className="flex items-center gap-2 rounded-md border border-white/10 bg-white/10 px-3 py-1.5 text-sm font-medium text-white transition-colors hover:border-white/20 hover:bg-white/15"
                  >
